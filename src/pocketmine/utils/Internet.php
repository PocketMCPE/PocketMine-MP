...
class Internet{
     ...
     * @return string
     */
    public static function getInternalIP(){
     ...
     * @param mixed $err reference parameter, will be set to the output of curl_error(). Use this to retrieve errors that occured during the operation.
     * @return InternetRequestResult|null
     */
    public static function getURL(string $page, int $timeout = 10, array $extraHeaders = [], &$err = null){
        try{
     ...
     * @param int $timeout
     * @param string[] $extraHeaders
     * @param mixed $err reference parameter, will be set to the output of curl_error(). Use this to retrieve errors that occurred during the operation.
     * @return InternetRequestResult|null
     */
    public static function postURL(string $page, $args, int $timeout = 10, array $extraHeaders = [], &$err = null){
        try{
            return self::simpleCurl($page, $timeout, $extraHeaders, [
                CURLOPT_POST => 1,
     ...
     */
    public static function simpleCurl(string $page, float $timeout = 10, array $extraHeaders = [], array $extraOpts = [], \Closure $onSuccess = null){
        if(!self::$online){
        ...
        try{
            ...
            if(!is_string($raw)) throw new \AssertionError("curl_exec() should return string|false when CURLOPT_RETURNTRANSFER is set");
